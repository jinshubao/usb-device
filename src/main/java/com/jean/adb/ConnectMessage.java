...
public class ConnectMessage extends Message {
     ...
     *
     * @param header The ADB message header.
     * @param data   The ADB message data.
     */
     ...
     * @param maxData    The maximum message body size.
     * @param systemType The system type. Must be either
     *                   {@link #SYSTEM_TYPE_BOOTLOADER}, {@link #SYSTEM_TYPE_DEVICE}
     *                   or {@link #SYSTEM_TYPE_HOST}.
     * @param serialNo   The serial number. A unique ID or empty.
     * @param banner     The banner. A human-readable version or identifier string.
     */
     ...
     * @param version  The protocol version.
     * @param maxData  The maximum message body size.
     * @param identity The identity as a UTF-8 encoded character array.
     */
