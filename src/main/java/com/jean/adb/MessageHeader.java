...
public class MessageHeader {
     ...
     * @param dataChecksum The data checksum. According to the documentation this is a
     *                     CRC32 checksum but in reality it is just the sum of all data
     *                     bytes.
     * @param magic        The inverted command. Can be used for validating the message
     *                     header.
     */
     ...
     *
     * @param bytes The ADB message header as bytes.
     */
